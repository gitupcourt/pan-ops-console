...
from app.models.enums import HARole, JobState, Severity, TaskPhase
from app.models.job import DeviceUpgradeTask, UpgradeJob
from app.models.precheck import PrecheckRun
from app.models.snapshot import Snapshot, SnapshotKind
...
def reconcile_markers_with_device_state(
    ...
    try:
        ...
        from app.services import precheck as precheck_svc  # noqa: PLC0415
        precheck_svc.probe_device(db, device, client=_client_for(device))
        db.refresh(device)
        probed = True
    except Exception as exc:  # noqa: BLE001
