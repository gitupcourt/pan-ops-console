...
from app.schemas import OIDCProviderCreate, OIDCProviderRead, OIDCProviderUpdate
from app.services.auth_dep import current_admin
from app.services.oidc import encrypt_client_secret, invalidate_discovery_cache
